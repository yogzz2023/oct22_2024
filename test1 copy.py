...
from PyQt5.QtWidgets import (QApplication,QWidget,QVBoxLayout,QPushButton,QFileDialog,QLabel,QComboBox,QTextEdit,QHBoxLayout,QSplitter,
    QCheckBox,QLineEdit,QDialog,QGridLayout,QGroupBox,QRadioButton,)
from PyQt5.QtGui import QFont, QIcon
from PyQt5.QtCore import Qt, QSize
from matplotlib.backends.backend_qt5agg import FigureCanvasQTAgg as FigureCanvas # Import FigureCanvas
...
class KalmanFilterGUI(QWidget):
    ...
    def initUI(self):
        ...
        # Left side: System Configuration and Controls
        ...
        self.config_button.setIcon(QIcon("config.png"))  # Replace "config.png" with the actual path
        ...
        left_layout.addWidget(self.track_mode_label)
        left_layout.addWidget(self.track_mode_combo)
        ...
        left_layout.addWidget(self.association_group)
        ...
        # self.imm_filter_button = QPushButton("IMM Filter")  # Add IMM Filter button
        # filter_layout.addWidget(self.imm_filter_button)
        ...
        self.file_upload_button.setIcon(QIcon("upload.png"))  # Replace "upload.png" with the actual path
        self.file_upload_button.clicked.connect(self.select_file)
        left_layout.addWidget(self.file_upload_button)

        # Process button
        self.process_button = QPushButton("Process")
        self.process_button.setIcon(QIcon("process.png"))  # Replace "process.png" with the actual path
        self.process_button.clicked.connect(self.process_data)
        left_layout.addWidget(self.process_button)

        main_layout.addWidget(left_widget)

        # Right side: Output and Plot
        ...
        self.canvas = FigureCanvas(plt.Figure()) # Create FigureCanvas instance
        ...
        # self.imm_filter_button.clicked.connect(lambda: self.select_filter("IMM"))
    ...
    def update_filter_selection(self):
        ...
        # self.imm_filter_button.setChecked(self.filter_mode == "IMM")
    ...
    # ... (Rest of the code, including functions and main)
