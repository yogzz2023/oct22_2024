...
from PyQt5.QtWidgets import (QApplication, QWidget, QVBoxLayout, QPushButton, QFileDialog, QLabel, QComboBox, QTextEdit,
                             ...
                             QFrame, QSizePolicy, QToolButton,QTabWidget, QMenu, QAction)
...
class KalmanFilterGUI(QWidget):
    def __init__(self):
        ...
        self.control_panel_collapsed = False  # Keep track of the panel's state
    ...
    def initUI(self):
        ...
        # Plot Button (No longer needed as plot is always displayed in tab)
    ...
    def update_plot(self):
        ...
        self.plot_tab.layout().addWidget(toolbar)
